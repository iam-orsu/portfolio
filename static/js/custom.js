(function ($) {
  ...
  $(".newsletter-form").ajaxChimp({
    url: "/post?u=60e1ffe2e8a68ce1204cd39a5&amp;id=42d6d188d9", // Your url MailChimp
...
$(document).ready(function () {
  // var contactModal = new bootstrap.Modal(document.getElementById('staticBackdrop'))
  // // debugger;

  // $('#popup-close').click(function(e) // You are clicking the close button
  // {
  // $('#staticBackdrop').fadeOut(); // Now the pop up is hiden.
  // });
  // $('#staticBackdrop').click(function(e)
  // {
...
document.addEventListener("DOMContentLoaded", function () {
  // Get the elements you want to check for
//   const triggerElement = document.getElementById("some-element");
  const footerElement = document.getElementById("footer");

  // Set the time limit for showing the modal
...
//   Function to check if the user has scrolled to the trigger element
  function checkScrollPosition() {
    if (!modalShown && window.scrollY >= footerElement.offsetTop) {
      showModal();
      modalShown = true;
    }
  }
  ...
  // Show the modal after the time limit has passed
  setTimeout(function () {
    if (!modalShown) {
      showModal();
      modalShown = true;
  ...
  // Show the modal when the user scrolls up to the footer
  window.addEventListener("scroll", function () {
    if (
      !modalShown &&
      window.scrollY + window.innerHeight >= footerElement.offsetTop
    ) {
      showModal();
      modalShown = true;
    }
